...
This branch (`hive_mind`) now carries the full Freeman runtime plus the multi-agent coordination layer.
...
In addition to the baseline runtime, this branch adds the hive-mind coordination primitives that let multiple agents share the same knowledge graph safely:
