...
from freeman_librarian.memory.selfmodel import SelfModelGraph, SelfModelNode, _ENGINE_CALLER_TOKEN
...
class ConsciousnessEngine:
    ...
    def _apply_diff(self, diff: dict[str, Any]) -> None:
        ...
        for edge_payload in diff.get("edges", []):
            from freeman_librarian.memory.selfmodel import SelfModelEdge
